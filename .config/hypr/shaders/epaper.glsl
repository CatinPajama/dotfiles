// E-Paper Shader with Grayscale Ordered Dithering (GLSL ES 1.0)

precision mediump float;
varying vec2 v_texcoord;
uniform sampler2D tex;

// Number of grayscale levels (e.g., 4, 8, 16)
const float numShades = 64.0;

// 8×8 Bayer Dithering Matrix function (No arrays due to GLSL ES 1.0)
